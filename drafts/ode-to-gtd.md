...
### Todoist
A well designed and implemented general task-management app. Requires a lot of tinkering to fit to the GTD system and then it's a sufficient solution. I love how responsive and intuitive the app is and that it has many third party integrations. Currently my second choice,
...
#### Cons 
1. Not GTD-native and not trivial to set up proper GTD even when trying.
