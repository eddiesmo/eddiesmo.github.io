...
**Braindumping on the go.** Using a speech-to-text app like Typeless or WisprFlow, I go for a walk and ramble my thoughts into Claude. It drafts a journal entry, we go back and forth on it, and by the time I'm back at my desk there's a polished entry waiting in the right folder - interlinked to related notes, with my thinking sharpened in a way that feels like I actually worked through the idea, not just captured it.
